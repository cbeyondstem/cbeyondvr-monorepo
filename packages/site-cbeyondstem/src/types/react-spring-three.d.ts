...
declare module 'react-spring/three' {
  export const useSpring: (obj: any) => any
  import { animated } from 'react-spring/renderprops'

  export { animated as a }
  // import { CSSProperties, RefObject } from 'react'
  // import { SpringConfig, SpringBaseProps, TransitionKeyProps, State } from 'react-spring/renderprops-universal'

  // export { SpringConfig, SpringBaseProps, TransitionKeyProps, State }

  // export { config, interpolate } from 'react-spring/renderprops-universal'
  ...
  // type InferFrom<T extends object> = T extends { to: infer TTo } ? Partial<TTo> : Partial<ForwardedProps<T>>
  ...
  // export interface UseTransitionProps<TItem, DS extends object> extends HooksBaseProps {
  //   /**
  ...
  //   /**
  //    * When true enforces that an item can only occur once instead of
  //    * allowing two or more items with the same key to co-exist in a stack
  //    * @default false
  //    */
  //   unique?: boolean
  //   /**
  ...
  //   /**
  //    * Values that apply to elements that are neither entering nor leaving
  //    * (you can use this to update present elements), or: item => values
  //    */
  ...
  //   keys: ((item: TItem) => TransitionKeyProps) | ReadonlyArray<TransitionKeyProps> | TransitionKeyProps | null,
