...
type ActionsUserProfileForm =
  | SetUserProfileFormAction

export const setUserProfileForm = (form:string) : SetUserProfileFormAction => ({ type: SET_USERPROFILEFORM_STR, form });

export const reducerUserProfileFormInitialState: StoreStateUserProfileForm = { 
  userProfileForm: "{}"
}
// Reducer
export const reducerUserProfileForm = (state: StoreStateUserProfileForm=reducerUserProfileFormInitialState, action: ActionsUserProfileForm): StoreStateUserProfileForm => {
  ...
  switch (action.type) {
    case SET_USERPROFILEFORM_STR:
      ...
      return Object.assign({}, state, { userProfileForm: action.form });
      break;
    default:
      return state;
  }
