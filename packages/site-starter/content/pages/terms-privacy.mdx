...
This privacy notice discloses the privacy practices for <p>{props.pageContext.site.siteMetadata.siteUrl}</p>
...
If you feel that we are not abiding by this privacy policy, you should contact us immediately via email <p>{props.pageContext.site.siteMetadata.contact}</p> .
