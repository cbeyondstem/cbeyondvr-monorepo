...
export interface FileFilterInput {
  ...
  childSvg?: Maybe<SvgFilterInput>
}

export interface SvgFilterInput {
  id?: Maybe<StringQueryOperatorInput>
...
export interface SiteSiteMetadataFilterInput {
  ...
  faviconSvg?: Maybe<StringQueryOperatorInput>
...
export enum FileFieldsEnum {
  ...
  ChildMdxFieldsSourceInstanceName = 'childMdx___fields___sourceInstanceName',
  ChildMdxFieldsRelativePath = 'childMdx___fields___relativePath',
  ChildMdxFieldsUid = 'childMdx___fields___uid',
  ChildMdxFieldsTitle = 'childMdx___fields___title',
  ChildMdxFieldsRoute = 'childMdx___fields___route',
  ...
  ChildMdxFieldsCategory = 'childMdx___fields___category',
  ...
  ChildAuthorJsonAvatarChildSvgId = 'childAuthorJson___avatar___childSvg___id',
  ChildAuthorJsonAvatarChildSvgChildren = 'childAuthorJson___avatar___childSvg___children',
  ChildAuthorJsonAvatarChildSvgContent = 'childAuthorJson___avatar___childSvg___content',
  ChildAuthorJsonAvatarChildSvgPath = 'childAuthorJson___avatar___childSvg___path',
  ChildAuthorJsonAvatarChildSvgSourceInstanceName = 'childAuthorJson___avatar___childSvg___sourceInstanceName',
  ChildAuthorJsonTwitter = 'childAuthorJson___twitter',
  ChildAuthorJsonGithub = 'childAuthorJson___github',
  ChildSvgId = 'childSvg___id',
  ChildSvgParentId = 'childSvg___parent___id',
  ChildSvgParentParentId = 'childSvg___parent___parent___id',
  ChildSvgParentParentChildren = 'childSvg___parent___parent___children',
  ChildSvgParentChildren = 'childSvg___parent___children',
  ChildSvgParentChildrenId = 'childSvg___parent___children___id',
  ChildSvgParentChildrenChildren = 'childSvg___parent___children___children',
  ChildSvgParentInternalContent = 'childSvg___parent___internal___content',
  ChildSvgParentInternalContentDigest = 'childSvg___parent___internal___contentDigest',
  ChildSvgParentInternalDescription = 'childSvg___parent___internal___description',
  ChildSvgParentInternalFieldOwners = 'childSvg___parent___internal___fieldOwners',
  ChildSvgParentInternalIgnoreType = 'childSvg___parent___internal___ignoreType',
  ChildSvgParentInternalMediaType = 'childSvg___parent___internal___mediaType',
  ChildSvgParentInternalOwner = 'childSvg___parent___internal___owner',
  ChildSvgParentInternalType = 'childSvg___parent___internal___type',
  ChildSvgChildren = 'childSvg___children',
  ChildSvgChildrenId = 'childSvg___children___id',
  ChildSvgChildrenParentId = 'childSvg___children___parent___id',
  ChildSvgChildrenParentChildren = 'childSvg___children___parent___children',
  ChildSvgChildrenChildren = 'childSvg___children___children',
  ChildSvgChildrenChildrenId = 'childSvg___children___children___id',
  ChildSvgChildrenChildrenChildren = 'childSvg___children___children___children',
  ChildSvgChildrenInternalContent = 'childSvg___children___internal___content',
  ChildSvgChildrenInternalContentDigest = 'childSvg___children___internal___contentDigest',
  ChildSvgChildrenInternalDescription = 'childSvg___children___internal___description',
  ChildSvgChildrenInternalFieldOwners = 'childSvg___children___internal___fieldOwners',
  ChildSvgChildrenInternalIgnoreType = 'childSvg___children___internal___ignoreType',
  ChildSvgChildrenInternalMediaType = 'childSvg___children___internal___mediaType',
  ChildSvgChildrenInternalOwner = 'childSvg___children___internal___owner',
  ChildSvgChildrenInternalType = 'childSvg___children___internal___type',
  ChildSvgInternalContent = 'childSvg___internal___content',
  ChildSvgInternalContentDigest = 'childSvg___internal___contentDigest',
  ChildSvgInternalDescription = 'childSvg___internal___description',
  ChildSvgInternalFieldOwners = 'childSvg___internal___fieldOwners',
  ChildSvgInternalIgnoreType = 'childSvg___internal___ignoreType',
  ChildSvgInternalMediaType = 'childSvg___internal___mediaType',
  ChildSvgInternalOwner = 'childSvg___internal___owner',
...
export enum MdxFieldsEnum {
  ...
  FieldsSourceInstanceName = 'fields___sourceInstanceName',
  FieldsRelativePath = 'fields___relativePath',
  FieldsUid = 'fields___uid',
  ...
  FieldsAuthorAvatarBlksize = 'fields___author___avatar___blksize',
  FieldsAuthorAvatarIno = 'fields___author___avatar___ino',
  FieldsAuthorAvatarBlocks = 'fields___author___avatar___blocks',
  ...
  FieldsCategory = 'fields___category',
  Id = 'id',
  ParentId = 'parent___id',
  ParentParentId = 'parent___parent___id',
  ParentParentParentId = 'parent___parent___parent___id',
...
export enum SitePageFieldsEnum {
  ...
  PluginCreatorPluginOptionsDefaultLayoutsPages = 'pluginCreator___pluginOptions___defaultLayouts___pages',
  PluginCreatorPluginOptionsDefaultLayoutsBlog = 'pluginCreator___pluginOptions___defaultLayouts___blog',
...
export enum SitePluginFieldsEnum {
  ...
  PluginOptionsDefaultLayoutsPages = 'pluginOptions___defaultLayouts___pages',
  PluginOptionsDefaultLayoutsBlog = 'pluginOptions___defaultLayouts___blog',
...
export enum SiteFieldsEnum {
  ...
  SiteMetadataFaviconSvg = 'siteMetadata___faviconSvg',
...
export enum AuthorJsonFieldsEnum {
  ...
  AvatarChildMdxFieldsSourceInstanceName = 'avatar___childMdx___fields___sourceInstanceName',
  AvatarChildMdxFieldsRelativePath = 'avatar___childMdx___fields___relativePath',
  AvatarChildMdxFieldsUid = 'avatar___childMdx___fields___uid',
  AvatarChildMdxFieldsTitle = 'avatar___childMdx___fields___title',
  AvatarChildMdxFieldsRoute = 'avatar___childMdx___fields___route',
  AvatarChildMdxFieldsDate = 'avatar___childMdx___fields___date',
  AvatarChildMdxFieldsCategory = 'avatar___childMdx___fields___category',
  ...
  AvatarChildSvgId = 'avatar___childSvg___id',
  AvatarChildSvgParentId = 'avatar___childSvg___parent___id',
  AvatarChildSvgParentChildren = 'avatar___childSvg___parent___children',
  AvatarChildSvgChildren = 'avatar___childSvg___children',
  AvatarChildSvgChildrenId = 'avatar___childSvg___children___id',
  AvatarChildSvgChildrenChildren = 'avatar___childSvg___children___children',
  AvatarChildSvgInternalContent = 'avatar___childSvg___internal___content',
  AvatarChildSvgInternalContentDigest = 'avatar___childSvg___internal___contentDigest',
  AvatarChildSvgInternalDescription = 'avatar___childSvg___internal___description',
  AvatarChildSvgInternalFieldOwners = 'avatar___childSvg___internal___fieldOwners',
  AvatarChildSvgInternalIgnoreType = 'avatar___childSvg___internal___ignoreType',
  AvatarChildSvgInternalMediaType = 'avatar___childSvg___internal___mediaType',
  AvatarChildSvgInternalOwner = 'avatar___childSvg___internal___owner',
  AvatarChildSvgInternalType = 'avatar___childSvg___internal___type',
  AvatarChildSvgContent = 'avatar___childSvg___content',
...
export interface SitePageContextFrontmatter {
  title?: Maybe<string>
...
export interface SitePluginPluginOptionsDefaultLayouts {
  pages?: Maybe<string>
...
export interface SvgGroupConnection {
  totalCount: number
...
export interface AllSvgQueryArgs {
  filter?: Maybe<SvgFilterInput>

  sort?: Maybe<SvgSortInput>
...
export interface DistinctSvgConnectionArgs {
  field: SvgFieldsEnum
}
export interface GroupSvgConnectionArgs {
  skip?: Maybe<number>
