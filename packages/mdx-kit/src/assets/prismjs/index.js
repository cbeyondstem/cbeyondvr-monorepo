...
export const prismToken = t => {
  ...
  return {
    ...
    '.language-css .token.string, .style .token.string': {
      color: p.colors.cssString
    },
    '.token.important': {
      fontWeight: p.fontWeights.body
    },
    '.token.bold': {
...
export const gatsbyHighlightLanguageBadges = t => {
  const p = prismTheme(t)
  return {
...
export const gatsbyHighlight = t => {
  const p = prismTheme(t)
  return {
