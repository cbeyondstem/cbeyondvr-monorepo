...
export const { Consumer: AllSvgConsumer, Provider: AllSvgProvider } = React.createContext({
  svgByPath: {}
} as AllSvgProps)
...
export const allSvgQueryRender: (children: React.ReactNode) => (data: Query) => React.ReactNode = children => data => {
