...
module.exports = {
  ...
  plugins: [
    ...
    {
      resolve: require.resolve('@cbeyond/mdx-kit/plugins/custom-page-creator'),
      options: {
        path: `${__dirname}/content/pages`
      }
    },
    ...
    // },
    {
      ...
      options: {
        extensions: ['.mdx', '.md'],
        defaultLayouts: {
          pages: require.resolve('./src/gatsby-tpl/mdx-layout-default.jsx'),
          blog: require.resolve('./src/gatsby-tpl/mdx-layout-default.jsx')
        },
        gatsbyRemarkPlugins: [
          {
