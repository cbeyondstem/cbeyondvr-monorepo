const site = {
  title: `Blas Chocolate`,
  author: `Henry Dehan and Eloi Devanneaux`,
  description: `Bean to Bar Chocolate Maker`,
  siteUrl: `https://blaschocolate.com/`,
  org: `Blas Chocolate`,
  contact: `sabina@blaschocolate.com`,
  favicon: './src/assets/img/blas-favicon.png',
  faviconSvg: './src/assets/img/blas-icon.comp.svg',
  logo: './src/assets/img/blas-icon.comp.svg',
  icon: './src/assets/img/blas-icon.comp.svg',
